...
+============================================+============+=======================================================+=============================================================+
| ``trustlens/explainability/gradcam.py``    | PyTorch    | Requires deep learning framework; not part of core ML | Full test coverage, CI-tested, documented API               |
+--------------------------------------------+------------+-------------------------------------------------------+-------------------------------------------------------------+
| ``trustlens/explainability/faithfulness.py``| NumPy      | Tied to explainability workflow                       | Same as above                                               |
+--------------------------------------------+------------+-------------------------------------------------------+-------------------------------------------------------------+
...
Open a `Discussion <https://github.com/Khanz9664/TrustLens/discussions>`_ or comment on a related issue.
