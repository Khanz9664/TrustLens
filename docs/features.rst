...
A single, actionable number: **0 to 100.** Computed from a **weighted combination (configurable, default ≈ 35 / 30 / 25 / 10)** of core dimensions with automatic **diagnostic penalties** for critical risks:
...
*Learn how these modules are structured internally in the* :doc:`architecture`.
...
The **Comparison Engine** recommends candidates for deployment.
...
* **Narrative**: High-density human-readable reports with structured methodology notes.
