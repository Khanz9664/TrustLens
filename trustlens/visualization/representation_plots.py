...
def plot_embedding_separability(
    ...
    with apply_style() as theme:
        ...
        if sil >= 0.5:
            sil_color = theme.brand["green"]
        elif sil >= 0.25:
            sil_color = theme.brand["amber"]
        else:
            sil_color = theme.brand["red"]
        ...
        draw_card(5.0, 6.5, "Within-Class Dist.", within, theme.brand["blue"])
        draw_card(8.0, 6.5, "Between-Class Dist.", between, theme.brand["purple"])

        # Separability ratio
        if ratio >= 1.5:
            ratio_color = theme.brand["green"]
        elif ratio >= 1.0:
            ratio_color = theme.brand["amber"]
        else:
            ratio_color = theme.brand["red"]
        ax.text(
            5,
            4.5,
